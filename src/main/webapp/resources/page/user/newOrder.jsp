...
<head>
    ...
    <style><%@include file="../../css/newOrder.css"%></style>
</head>
<body>
...
<nav class="col-md-2 d-none d-md-block bg-light sidebar">
    <div class="sidebar-sticky">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="app?action=new_Order">
...
<main role="main">
    ...
    <c:if test="${!ordered}">
    <form method="post" class="form-order" action="app?action=new_Order">
