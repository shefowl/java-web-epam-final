...
<nav class="col-md-2 d-none d-md-block bg-light sidebar">
    <div class="sidebar-sticky">
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link active" href="app?action=user_Page">
            ...
            <li class="nav-item">
                <a class="nav-link" href="app?action=change_User_Password">
    ...
    <c:if test="${currentOrder.driverId == '0' && !driverRequested}">
        ...
        <table class="table">
            ...
            <tr class="ableDrivers">
                ...
                <th scope="col" class="scope">Price</th>
            ...
            <c:forEach items="${drivers}" var="ableDriver" varStatus="status">
                <tr>
                    ...
                    <form method="post" action="app?action=drivers" class="ableDrivers">
                        <%--<div class="col">--%>
                            <th>
                            <div class="ableDrivers row">
                                <c:out value="${ableDriver.name}" />
                            </div>
                            </th>
                            <th>
                            <div class="row">
                                <c:out value="${ableDriver.email}" />
                            </div>
                            </th>
                            <th>
                            <div class="row">
                                 <c:out value="${prices[status.index]}"/>
                            </div>
                            </th>
                        <%--</div>--%>
                            <td>
                            <button class="btn btn-lg btn-success" type="submit">Choose</button>
                            </td>
