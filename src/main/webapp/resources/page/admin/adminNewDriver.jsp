...
<head>
    ...
    <style><%@include file="../../css/newDriver.css"%></style>
</head>
<body>
...
<nav class="col-md-2 d-none d-md-block bg-light sidebar">
    <div class="sidebar-sticky">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link" href="admin?action=change_Admin_Password">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="admin?action=new_Driver">
...
<form method="post" class="needs-validation" action="admin?action=new_Driver">
<div class="row">
