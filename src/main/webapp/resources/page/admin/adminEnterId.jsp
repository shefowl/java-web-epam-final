...
<%--<nav class="col-md-2 d-none d-md-block bg-light sidebar">--%>
    <%--<div class="sidebar-sticky">--%>
        <%--<ul class="nav flex-column">--%>
            ...
            <%--</li>--%>
            <%--<li class="nav-item">--%>
                <%--<a class="nav-link active" href="admin?action=participant_Id">--%>
                    <%--<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-truck"><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline></svg>--%>
...
<%--<main role="main" class="inner cover">--%>
    <%--<form method="post" action="admin?action=find_By_Id" class="form-password">--%>
        <%--<h1 class="text-center">Find participant</h1>--%>

        <%--<label for="id" class="sr-only">ID</label>--%>
        <%--<input type="number" name="id" id="id" class="form-control" placeholder="ID" required autofocus/>--%>
            ...
            <div class="col-xl-4 col-lg-6 col-sm-4" ml-auto>
                <div class="authorization">
                    ...
                    <div class="form__name">
                        <h2><fmt:message key="text.adminEnterId.id" bundle="${locale}"/>/h2>
                    ...
                    <div class="info__fields">
                        ...
                        <form method="post" action="admin?action=find_By_Id" class="form__login" size="30%">
                            <p class="field">
                                <input type="number" name="id" id="id" placeholder="<fmt:message key="text.adminEnterId.id.placeholder" bundle="${locale}"/>">
                            </p>

                            <p class="submition">
                                <button type="submit" class="submit" name="submit"><fmt:message key="text.adminEnterId.id.button" bundle="${locale}"/></button>
                            </p>
                        </form>
