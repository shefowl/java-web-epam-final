...
<head>
    ...
    <style><%@include file="resources/css/signUpForm.css"%></style>
...
<nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
    ...
    <nav class="nav-buber nav-masthead justify-content-center">
        ...
        <a class="nav-link active" href="hello?action=registration">Sign Up</a>
...
<form method="post" action="hello?action=signUp" class="form-signin">
